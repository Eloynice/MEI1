...
for line in lines:
	split = line.split(",")
	if(split[2] == "jan" or split[2] == "feb" or split[2] == "mar" or split[2] == "apr" or split[2] == "may" or split[2] == "aug" or split[2] == "jun" or split[2] == "jul" or split[2] == "sep" or split[2] == "oct" or split[2] == "nov" or split[2] == "dec"):
		fw.write(str(float(split[12]))+"\n")
fw.close()


f = open("csvs/yearCount.txt","r")
lines = f.readlines()
n0 = 0
n1 = 0
n50 = 0
